...
# from yolo_utils import load_yolo_annotations
...
#         path_layout_2.addWidget(QtWidgets.QLabel("Label Folder:"))
...
#         folder = QtWidgets.QFileDialog.getExistingDirectory(self, "Select Label Folder", os.path.expanduser("~/Downloads"))
#         if folder:
...
class DatasetViewer(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.format_selector.currentTextChanged.connect(self.try_load_dataset)
